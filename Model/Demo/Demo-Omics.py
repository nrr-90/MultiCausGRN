...
exp_file = '/content/drive/MyDrive/MultiCausGRN/PBMC_multiome_preprocessed/PBMC/Model_INPUT_A/BL--ExpressionData.csv'
...
train_file = "/content/drive/MyDrive/MultiCausGRN/PBMC_multiome_preprocessed/PBMC/Model_DOROTHEA_OMNIPATH/Train_set.csv"
test_file = "/content/drive/MyDrive/MultiCausGRN/PBMC_multiome_preprocessed/PBMC/Model_DOROTHEA_OMNIPATH/Validation_set.csv"
val_file = "/content/drive/MyDrive/MultiCausGRN/PBMC_multiome_preprocessed/PBMC/Model_DOROTHEA_OMNIPATH/Test_set.csv"


tf_embed_path = r'Result/MultiOmics/'+data_type+' '+str(num)+'/Channel1.csv'
target_embed_path = r'Result/MultiOmics/'+data_type+' '+str(num)+'/Channel2.csv'
if not os.path.exists('Result/MultiOmics/'+data_type+' '+str(num)):
    os.makedirs('Result/MultiOmics/'+data_type+' '+str(num))
